      ...
      <div className="min-h-screen wine-pattern pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-xl text-amber-100/80 max-w-3xl mx-auto">Una selección de las mejores bodegas, evaluadas con puntajes exclusivos de la guía Vako Club</p>
          </motion.div>
