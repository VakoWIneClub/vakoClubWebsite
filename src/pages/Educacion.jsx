...
const Educacion = () => {
  ...
  const categories = [
    ...
    { id: 'cata', name: 'Cata de Vinos' },
    { id: 'maridaje', name: 'Maridajes' },
    { id: 'historia', name: 'Historia del Vino' },
          ...
          >
            {filteredCourses.map((course, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="wine-card rounded-2xl overflow-hidden wine-hover cursor-pointer"
