  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? 'wine-glass-effect wine-shadow' : 'bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span className="hidden sm:block text-sm font-light text-amber-100/70 tracking-wider">
              Exclusive Wine Club
            </span>
          </Link>
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              {!user && (
                <div className="pt-4 border-t border-amber-200/20 flex flex-col space-y-2">
