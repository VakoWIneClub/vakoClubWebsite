  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Inicia sesión en tu cuenta de Vako Club para acceder a tus beneficios."
        />
      </Helmet>
          ...
          <div className="wine-glass-effect rounded-2xl p-8 md:p-12 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-amber-100/80">
                Bienvenido de nuevo a Vako Club.
              </p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-amber-200 font-medium">
                  Email
                </Label>
