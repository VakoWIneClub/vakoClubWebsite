...
- **Landing pages:** no existe todavía una página de venta dedicada para las guías en PDF dentro del sitio (`src/pages/`). Es una de las primeras tareas naturales de `vako-landing`.
