...
import { ShoppingBag, Award, Truck, Shield, Wine, Paintbrush, Shirt, GlassWater, ExternalLink, BadgePercent, Copy } from 'lucide-react';
...
const vinosSeleccionados = [{
  ...
  descripcion: 'Un Rioja excepcional con 24 meses en barrica de roble francés.',
  alcohol: '14.5%',
...
const arteYDeco = [{
  ...
  descripcion: 'Una hermosa lámina que captura la esencia de los viñedos al atardecer.',
  stock: 20,
  destacado: true,
  descuento: 17
}, {
  ...
  descripcion: 'Set de 4 posavasos de corcho natural con diseños vitivinícolas.',
  stock: 50,
  destacado: false,
  descuento: 25
}];
const merchandising = [{
  ...
  descripcion: 'Camiseta de algodón orgánico con un diseño minimalista y elegante.',
  stock: 40,
  destacado: true,
  descuento: 14
}, {
...
const accesorios = [{
  ...
  descripcion: 'Sacacorchos de dos tiempos con mango de madera y acero inoxidable.',
  stock: 25,
  destacado: true,
  descuento: 20
}, {
  ...
  descripcion: 'Decantador de cristal soplado a mano para oxigenar tus mejores vinos.',
  stock: 15,
  destacado: false,
  descuento: 20
}, {
  ...
  descripcion: 'Sacacorchos profesional de doble palanca con mango de madera de roble natural y espiral de acero inoxidable. El regalo perfecto.',
  alcohol: 'N/A',
  ...
  destacado: true,
  descuento: 20,
  externalLink: 'https://www.amazon.es/Semecca%C2%AE-Sacacorchos-natural-abridor-perfecto/dp/B0D5BSP34N/'
}];
const ViewEtsyButton = () => <div className="mt-8 text-center">
        <a href="https://www.etsy.com/shop/VakoWineClub" target="_blank" rel="noopener noreferrer">
  ...
  showEtsyButton = false
    ...
    duration: 0.5
      ...
      <div className="inline-flex items-center gap-4">
        ...
        <h2 className="font-playfair text-4xl font-bold text-amber-200">{title}</h2>
      </div>
    </motion.div>
...
const MemberCouponSection = () => {
  ...
  return <div className="py-12 bg-stone-900/50 rounded-2xl my-16">
      <motion.div initial={{
      opacity: 0,
      y: 20
    }} whileInView={{
      ...
      duration: 0.6
        ...
        <h2 className="font-playfair text-3xl font-bold text-amber-200">Tu Beneficio Exclusivo</h2>
        <p className="mt-2 text-lg text-amber-100/80">Como miembro de Vako Club, tienes un cupón de descuento del 20% en todos los productos de nuestra tienda exclusiva.</p>
        <div className="mt-6 bg-stone-800/50 border border-amber-500/30 rounded-lg p-4 inline-flex items-center justify-center gap-4">
          <span className="font-mono text-2xl text-amber-300 tracking-widest">BONARDA20</span>
...
const Tienda = () => {
  ...
  return <>
      <Helmet>
        ...
        <meta name="description" content="Explora la Tienda Exclusiva de Vako Club. Encuentra vinos de selección, arte, merchandising y accesorios únicos para amantes del vino." />
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          duration: 0.8
            ...
            <p className="text-xl md:text-2xl text-amber-100/90 max-w-3xl mx-auto">
              Descubre artículos únicos de nuestra comunidad: desde vinos de selección hasta arte, merchandising y accesorios.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Section title="Vinos Seleccionados" icon={Wine} products={vinosSeleccionados} />
        <div className="border-t border-amber-500/10"></div>
        <Section title="Arte y Deco" icon={Paintbrush} products={arteYDeco} showEtsyButton />
        <div className="border-t border-amber-500/10"></div>
        <Section title="Merchandising" icon={Shirt} products={merchandising} showEtsyButton />
        <div className="border-t border-amber-500/10"></div>
        <Section title="Accesorios" icon={GlassWater} products={accesorios} showEtsyButton />
      </div>
