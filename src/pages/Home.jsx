      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-center text-base space-y-3">
            <p>
              ¡Gracias por unirte! Tu cuenta ha sido verificada. Como regalo de
              bienvenida, aquí tienes tu{" "}
              <strong>cupón del 20% de descuento</strong>.
            </p>
            <div className="bg-stone-800/50 border border-amber-500/30 rounded-lg p-3 flex items-center justify-center gap-4">
              <span className="font-mono text-lg text-amber-300 tracking-widest">
                BONARDA20%
              </span>
...
const Home = () => {
  ...
  const logoUrl =
    "https://storage.googleapis.com/hostinger-horizons-assets-prod/1376a1dc-c051-4229-8281-e847b8e98dae/679ab33053f5b8d0d4f73e2d796f0a32.png";
  const features = [
    {
      icon: Users,
      title: "Comunidad Exclusiva",
      description:
        "Conecta con otros amantes del vino y comparte experiencias únicas.",
    ...
    },
    {
      ...
      title: "Tienda Online",
      description:
        "Descubre vinos excepcionales cuidadosamente seleccionados por sommeliers.",
    ...
    },
    {
      ...
      description:
        "Aprende sobre catas, maridajes y la historia del vino con nuestros expertos.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Bienvenido a Vako Club, tu destino para descubrir, aprender y disfrutar del fascinante mundo del vino. Únete a nuestra comunidad exclusiva."
        />
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-amber-100/80 max-w-3xl mx-auto leading-relaxed">
              Sumérgete en el fascinante mundo del vino con nuestra comunidad
              exclusiva de expertos y amantes del buen vino.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-amber-100/70 max-w-3xl mx-auto">
              Descubre por qué Vako Club es la comunidad de vinos más elegante y
              educativa del mundo.
            </p>
          </motion.div>
      ...
      <section className="py-20 wine-glass-effect">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-amber-100/70 max-w-3xl mx-auto">
              Explora productos únicos creados y seleccionados por nuestros
              miembros.
            </p>
          </motion.div>
                ...
                <Link to="/tienda" key={index}>
                  ...
                  >
                    <div className="aspect-w-3 aspect-h-4 bg-gradient-to-br from-amber-900/20 to-red-900/20 p-8 flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-amber-100/70">{article.description}</p>
                    </div>
                  </motion.div>
                </Link>
              );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-amber-100/70 max-w-2xl mx-auto">
              Descubre un mundo de sabores, conocimiento y experiencias
              compartidas con otros apasionados del vino.
            </p>
            <p className="text-xl text-amber-100/70 max-w-2xl mx-auto">
              Suscríbete a nuestra comunidad y obtén un 20% de descuento en
              todos nuestros artículos exclusivos.
            </p>
