...
const CONTENT = {
  ...
  coleccion: {
    ...
    title: 'Argentina es la segunda entrega. España y Francia ya están disponibles.',
    text: 'La Guía del Vino Español fue la primera entrega de la colección, y la Guía del Vino Francés la tercera y última. Comprando ahora quedás con una invitación a la Membresía Gratuita de Vako Club.',
    links: [
  ...
  faq: {
    ...
    items: [
      ...
      { q: '¿Esta compra incluye la guía de España o Francia?', a: 'No — cada guía regional se vende por separado. Las guías de España y Francia ya están disponibles, así que como comprador de Argentina podés sumarlas cuando quieras.' },
