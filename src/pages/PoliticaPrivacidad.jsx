...
const LegalSection = ({ title, children }) => (
  <motion.div
    ...
    className="mb-8"
  >
    <h2 className="font-playfair text-2xl font-bold wine-text-gradient mb-4">
      {title}
    </h2>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Conoce cómo Vako Club recopila, utiliza y protege tu información personal."
        />
      </Helmet>
        ...
        >
          ...
          <div className="wine-glass-effect rounded-2xl p-8 md:p-12 shadow-2xl">
            <LegalSection title="1. Introducción">
              <p>
                En Vako Wine Club, respetamos tu privacidad y nos comprometemos
                a proteger tus datos personales. Esta política de privacidad te
            ...
            <LegalSection title="2. Información que Recopilamos">
              ...
              <ul>
                <li>
                  <strong>Datos de Identidad:</strong> Incluye nombre, apellido
                  y nombre de usuario.
                </li>
                <li>
                ...
                <li>
                  <strong>Datos Técnicos:</strong> Incluye dirección IP, datos
                  de inicio de sesión, tipo y versión del navegador, etc.
                </li>
                <li>
                  <strong>Datos del Perfil:</strong> Incluye tu nombre de
                  usuario y contraseña, tus intereses, preferencias, y
                  comentarios.
                </li>
                <li>
            ...
            <LegalSection title="3. Cómo Utilizamos tu Información">
              ...
              <ul>
                ...
                <li>
                  Administrar y proteger nuestro negocio y este sitio web.
                </li>
                <li>
                  Entregarte contenido relevante del sitio web y anuncios, y
                  medir o comprender la efectividad de la publicidad que te
                  servimos.
                </li>
              </ul>
            </LegalSection>
            ...
            <LegalSection title="4. Cookies">
              <p>
                ...
                cookies del navegador, o para que te avise cuando los sitios web
                establezcan o accedan a las cookies. Si deshabilitas o rechazas
                las cookies, ten en cuenta que algunas partes de este sitio web
            ...
            <LegalSection title="5. Seguridad de los Datos">
              <p>
                ...
                que tus datos personales se pierdan accidentalmente, se usen o
                se accedan de forma no autorizada, se alteren o se divulguen.
                Utilizamos la plataforma Supabase para garantizar la seguridad y
                gestión de los datos de autenticación.
              </p>
            </LegalSection>
            ...
            <LegalSection title="6. Tus Derechos Legales">
              <p>
                ...
                protección de datos en relación con tus datos personales, como
                el derecho a solicitar acceso, corrección, eliminación o
                restricción de tus datos personales.
              </p>
            </LegalSection>
            ...
            <LegalSection title="7. Contacto">
              <p>
                ...
                favor contáctanos a través de la información proporcionada en
