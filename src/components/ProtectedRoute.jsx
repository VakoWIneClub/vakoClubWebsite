    ...
    return (
       <div className="min-h-[60vh] flex items-center justify-center wine-pattern p-4">
          ...
          >
              ...
              <h1 className="font-playfair text-4xl font-bold wine-text-gradient mb-4">Acceso Restringido</h1>
              ...
              <div className="flex gap-4 justify-center">
                  <Button asChild size="lg">
                      <Link to="/login" state={{ from: location }} replace>Iniciar Sesión</Link>
                  </Button>
                  <Button asChild variant="outline" size="lg">
                      <Link to="/suscripcion" state={{ from: location }} replace>Registrarse</Link>
                  </Button>
              </div>
          </motion.div>
      </div>
